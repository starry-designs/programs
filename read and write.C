...
fptr = fopen("C:\\Users\\ALEX UNGUSO\\OneDrive\\Documents\\Desktop\\C programs\\file.txt", "r");
if (fptr == NULL) {
...
// Open sample.txt
fptr = fopen("C:\\Users\\ALEX UNGUSO\\OneDrive\\Documents\\Desktop\\C programs\\sample.txt", "w");
if (fptr == NULL) {
